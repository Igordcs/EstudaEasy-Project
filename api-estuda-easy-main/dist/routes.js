...
routes.post('/user/notes', _loginRequired2.default, notesController.create);
routes.get('/user/notes', _loginRequired2.default, notesController.index);
...
routes.get('/quizquestion/quiz/:id', _loginRequired2.default, QuizQuestionController.startQuiz);
